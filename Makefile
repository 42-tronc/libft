...
#    Updated: 2023/04/04 10:55:08 by croy             ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
SRC_LIBFT := ft_atoi.c ft_isalpha.c ft_isprint.c ft_memcpy.c ft_strlcpy.c ft_strnstr.c ft_toupper.c ft_bzero.c ft_isascii.c ft_memchr.c ft_memmove.c \
	ft_strchr.c ft_strlen.c ft_strrchr.c ft_isalnum.c ft_isdigit.c ft_memcmp.c ft_memset.c ft_strlcat.c ft_strcmp.c ft_strncmp.c ft_tolower.c ft_strdup.c \
